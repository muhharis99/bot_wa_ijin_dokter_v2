    ...
    <main>
        ...
        <section class="hero">
            <div>
                ...
                <p>
                    Pesan reminder dikirim langsung melalui WhatsApp Gateway setelah tombol WhatsApp ditekan.
                </p>
            </div>
            ...
            <?php foreach ($byDoctor as $group): ?>
                ...
                <article class="card">
                    <div class="card-top">
                        ...
                        <span class="status <?= e(strtolower($status)) ?>">
                            <?= e($status) ?>
                        </span>
                    </div>
            ...
            try {
                ...
                if (data.hasQr) {
                    gatewayStatus.textContent =
                        'QR tersedia - scan WhatsApp terlebih dahulu';
