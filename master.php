...
<body>
    <header>
        ...
        <nav>
            ...
            <a class="active" href="master.php">Master Data</a>
    ...
    <main>
        ...
        <section class="forms">
            ...
            <form method="post" class="panel">
                ...
                <select required name="dokter_kd">
                ...
                <tbody>
                    <?php foreach ($schedules as $schedule): ?>
                        <tr>
                            ...
                            <td>
                                <?= e($schedule['jam_mulai']) ?>–<?= e($schedule['jam_selesai']) ?>
                            </td>
                            <td><?= e($schedule['lokasi']) ?></td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
